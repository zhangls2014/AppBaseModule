...
interface Deps {
    ...
    //fragment
    String fragment = "androidx.fragment:fragment-ktx:1.6.0"
    //activity
    String activity = "androidx.activity:activity:1.7.2"
    //andAnnotations
    String andAnnotations = "androidx.annotation:annotation:1.6.0"
    //materialDesign
    String materialDesign = "com.google.android.material:material:1.9.0"
    //cardView
    ...
    //coreKtx
    String coreKtx = "androidx.core:core-ktx:1.10.1"
    //preference
    ...
    //splashScreen
    String splashScreen = "androidx.core:core-splashscreen:1.0.1"
    //media3UI
    String media3UI = "androidx.media3:media3-ui:1.1.0"
    //media3Exoplayer
    String media3Exoplayer = "androidx.media3:media3-exoplayer:1.1.0"
     ...
     */
    //cameraXCore
    String cameraXCore = "androidx.camera:camera-core:1.2.3"
    //cameraXCamera2
    String cameraXCamera2 = "androidx.camera:camera-camera2:1.2.3"
    //cameraXLifecycle
    String cameraXLifecycle = "androidx.camera:camera-lifecycle:1.2.3"
    //cameraXView
    String cameraXView = "androidx.camera:camera-view:1.2.3"
    //cameraXExtensions
    ...
    //coroutinesAndroid
    String coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.2"

    /*
     * compose
     */
    //composeActivity
    String composeActivity = "androidx.activity:activity-compose:1.7.2"
    //composeConstraintLayout
    String composeConstraintLayout = "androidx.constraintlayout:constraintlayout-compose:1.0.1"
    //composeNavigation
    String composeNavigation = "androidx.navigation:navigation-compose:2.6.0"
    //accompanistSystemUiController
    String accompanistSystemUiController = "com.google.accompanist:accompanist-systemuicontroller:0.30.1"
    //accompanistWebView
    ...
    //okHttp
    String okHttp = "com.squareup.okhttp3:okhttp:4.11.0"
    //okHttpLogging
    String okHttpLogging = "com.squareup.okhttp3:logging-interceptor:4.11.0"
    //okio
    ...
    //slf4j
    String slf4j = "org.slf4j:slf4j-api:2.0.5"

    //mavericks : https://github.com/airbnb/mavericks
    String mavericks = "com.airbnb.android:mavericks:3.0.5"
    //mavericksNavigation
    ...
    String coil = "io.coil-kt:coil:2.4.0"
    //coilBase
    String coilBase = "io.coil-kt:coil-base:2.4.0"
    //coilGif
    String coilGif = "io.coil-kt:coil-gif:2.4.0"
    //coilSVG
    String coilSVG = "io.coil-kt:coil-svg:2.4.0"
    //composeCoil
    String composeCoil = "io.coil-kt:coil-compose:2.4.0"
    ...
    String uCrop = "com.github.yalantis:ucrop:2.2.8"
    ...
    */
    ...
    String leakCanaryAndroid = "com.squareup.leakcanary:leakcanary-android:2.12"
    ...
    String glog = "cn.huolala.glog.android:glog-android-static:1.0.1"
